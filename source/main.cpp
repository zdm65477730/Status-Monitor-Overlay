	...
	std::string jsonStr = R"(
		{
			...
			"UpdateOneResolutionTitleFullOverlayCustomDrawerText": "Resolution: %dx%d",
			"UpdateResolutionTitleFullOverlayCustomDrawerText": "Resolution: %dx%d | %dx%d",
			"UpdateReadSpeedTitleFullOverlayCustomDrawerText": "Read speed: %.2f MiB/s",
