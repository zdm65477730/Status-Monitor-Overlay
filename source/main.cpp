	...
	std::string jsonStr = R"(
		{
			...
			"UpdateBatteryChargeInfoAVGBatteryOverlayCustomDrawerText": " [5s AVG]",
			"UpdateBatteryChargeInfoChargerBatteryOverlayCustomDrawerText": "Battery Actual Capacity: %.0fmAh\nBattery Designed Capacity: %.0fmAh\nBattery Temperature: %.1f\u00B0C\nBattery Raw Charge: %.1f%%\nBattery Age: %.1f%%\nBattery Voltage (%ds AVG): %.0fmV\nBattery Current Flow (%ss AVG): %+.0fmA\nBattery Power Flow%s: %+.3fW\nBattery Remaining Time: %s\nCharger Type: %u\nCharger Max Voltage: %umV\nCharger Max Current: %umA",
			"UpdateBatteryChargeInfoBatteryBatteryOverlayCustomDrawerText": "Battery Actual Capacity: %.0fmAh\nBattery Designed Capacity: %.0fmAh\nBattery Temperature: %.1f\u00B0C\nBattery Raw Charge: %.1f%%\nBattery Age: %.1f%%\nBattery Voltage (%ds AVG): %.0fmV\nBattery Current Flow (%ss AVG): %+.0fmA\nBattery Power Flow%s: %+.3fW\nBattery Remaining Time: %s",
			...
			"UpdateNVJPGMiscOverlayCustomDrawerText": "NVENC: %.1fMHz",
