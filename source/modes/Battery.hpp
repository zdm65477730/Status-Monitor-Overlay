	...
	virtual void update() override {
		...
		if (ChargerConnected)
			snprintf(Battery_c, sizeof Battery_c,
				"UpdateBatteryChargeInfoChargerBatteryOverlayCustomDrawerText"_tr.c_str(),
				...
				batteryFiltered ? "" : "UpdateBatteryChargeInfoAVGBatteryOverlayCustomDrawerText"_tr.c_str(), PowerConsumption,
				tempBatTimeEstimate,
				ChargerConnected,
				ChargerVoltageLimit,
				ChargerCurrentLimit
			...
			snprintf(Battery_c, sizeof Battery_c,
				"UpdateBatteryChargeInfoBatteryBatteryOverlayCustomDrawerText"_tr.c_str(),
				actualFullBatCapacity,
				designedFullBatCapacity,
				(float)_batteryChargeInfoFields.temperature_celcius / 1000,
				(float)_batteryChargeInfoFields.battery_charge_percentage / 1000,
